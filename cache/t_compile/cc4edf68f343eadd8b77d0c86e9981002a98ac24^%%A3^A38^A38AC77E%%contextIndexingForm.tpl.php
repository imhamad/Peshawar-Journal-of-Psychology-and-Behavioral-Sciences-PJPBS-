<?php /* Smarty version 2.6.25-dev, created on 2019-03-28 05:09:23
         compiled from controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'help', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 13, false),array('function', 'url', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 22, false),array('function', 'csrf', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 23, false),array('function', 'fbvElement', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 29, false),array('function', 'translate', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 36, false),array('function', 'fbvFormButtons', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 41, false),array('block', 'fbvFormArea', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 27, false),array('block', 'fbvFormSection', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 28, false),array('modifier', 'assign', 'controllers/tab/settings/contextIndexing/form/contextIndexingForm.tpl', 35, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'searchEngineIndexing')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array('label' => "manager.setup.searchEngineIndexing.sitemap")); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_PAGE,'page' => 'sitemap'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'sitemapPath') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'sitemapPath'));?>

			<div class="description"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.searchEngineIndexing.sitemapDescription",'path' => $this->_tpl_vars['sitemapPath']), $this);?>
</div>
		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
