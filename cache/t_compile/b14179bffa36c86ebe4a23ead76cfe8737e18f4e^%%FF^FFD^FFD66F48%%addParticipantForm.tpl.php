<?php /* Smarty version 2.6.25-dev, created on 2019-03-18 05:19:57
         compiled from controllers/grid/users/stageParticipant/addParticipantForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'help', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 13, false),array('function', 'url', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 25, false),array('function', 'csrf', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 32, false),array('function', 'load_url_in_div', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 42, false),array('function', 'fbvElement', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 45, false),array('function', 'translate', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 57, false),array('function', 'fbvFormButtons', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 58, false),array('modifier', 'json_encode', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 20, false),array('modifier', 'escape', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 36, false),array('modifier', 'assign', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 41, false),array('block', 'fbvFormArea', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 35, false),array('block', 'fbvFormSection', 'controllers/grid/users/stageParticipant/addParticipantForm.tpl', 44, false),)), $this); ?>
...
<script type="text/javascript">
	$(function() {
		...
		$('#addParticipantForm').pkpHandler('$.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler',
			{
				possibleRecommendOnlyUserGroupIds: <?php echo json_encode($this->_tpl_vars['possibleRecommendOnlyUserGroupIds']); ?>
,
				recommendOnlyUserGroupIds: <?php echo json_encode($this->_tpl_vars['recommendOnlyUserGroupIds']); ?>
,
				blindReviewerIds: <?php echo json_encode($this->_tpl_vars['blindReviewerIds']); ?>
,
				blindReviewerWarning: <?php echo json_encode($this->_tpl_vars['blindReviewerWarning']); ?>
,
				blindReviewerWarningOk: <?php echo json_encode($this->_tpl_vars['blindReviewerWarningOk']); ?>
,
...
" />
		...
		<?php $this->_tag_stack[] = array('fbvFormSection', array('title' => "stageParticipants.options",'list' => 'true','class' => 'recommendOnlyWrapper')); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'checkbox','name' => 'recommendOnly','id' => 'recommendOnly','label' => "stageParticipants.recommendOnly"), $this);?>
