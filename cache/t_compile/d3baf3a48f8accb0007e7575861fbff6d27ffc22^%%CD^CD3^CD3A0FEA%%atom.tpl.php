<?php /* Smarty version 2.6.25-dev, created on 2019-03-01 21:48:13
         compiled from plugins/plugins/generic/webFeed/generic/webFeed:templates/atom.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/atom.tpl', 12, false),array('modifier', 'strip', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/atom.tpl', 17, false),array('modifier', 'date_format', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/atom.tpl', 28, false),array('modifier', 'regex_replace', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/atom.tpl', 28, false),array('function', 'url', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/atom.tpl', 16, false),array('function', 'translate', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/atom.tpl', 91, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
<feed xmlns="http://www.w3.org/2005/Atom">
	...
	<title><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['journal']->getLocalizedName())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')))) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)); ?>
</title>
...
?>
	...
	<link rel="alternate" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journal']->getPath()), $this);?>
" />
...
?>
			<entry>
								<id><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['article']->getBestArticleId()), $this);?>
</id>
...
?>
				...
				<?php endforeach; endif; unset($_from); ?>
				<link rel="alternate" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['article']->getBestArticleId()), $this);?>
" />

				<?php if ($this->_tpl_vars['article']->getLocalizedAbstract()): ?>
					<summary type="html" xml:base="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['article']->getBestArticleId()), $this);?>
