<?php /* Smarty version 2.6.25-dev, created on 2019-03-11 07:47:15
         compiled from controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'concat', 'controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl', 10, false),array('function', 'url', 'controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl', 19, false),array('function', 'csrf', 'controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl', 20, false),array('function', 'fbvElement', 'controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl', 23, false),array('function', 'fbvFormButtons', 'controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl', 31, false),array('block', 'fbvFormArea', 'controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl', 21, false),array('block', 'fbvFormSection', 'controllers/grid/submissions/exportPublishedSubmissionsGridFilter.tpl', 22, false),)), $this); ?>
...
" method="post">
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => ((is_array($_tmp='submissionSearchFormArea')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['filterData']['gridId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['filterData']['gridId'])))); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'select','name' => 'issueId','id' => ((is_array($_tmp='issueId')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['filterData']['gridId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['filterData']['gridId'])),'from' => $this->_tpl_vars['filterData']['issues'],'selected' => $this->_tpl_vars['filterSelectionData']['issueId'],'size' => $this->_tpl_vars['fbvStyles']['size']['SMALL'],'translate' => false,'inline' => 'true'), $this);?>

			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'select','name' => 'statusId','id' => ((is_array($_tmp='statusId')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['filterData']['gridId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['filterData']['gridId'])),'from' => $this->_tpl_vars['filterData']['status'],'selected' => $this->_tpl_vars['filterSelectionData']['statusId'],'size' => $this->_tpl_vars['fbvStyles']['size']['SMALL'],'translate' => false,'inline' => 'true'), $this);?>
