<?php /* Smarty version 2.6.25-dev, created on 2019-03-11 07:38:43
         compiled from plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 12, false),array('function', 'url', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 21, false),array('function', 'csrf', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 22, false),array('function', 'fbvElement', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 27, false),array('function', 'fbvFormButtons', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 74, false),array('block', 'fbvFormArea', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 24, false),array('block', 'fbvFormSection', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 25, false),array('modifier', 'compare', 'plugins/plugins/pubIds/doi/pubIds/doi:templates/settingsForm.tpl', 27, false),)), $this); ?>
 ...
 ?>
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'doiObjectsFormArea','title' => "plugins.pubIds.doi.manager.settings.doiObjects")); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array('list' => 'true')); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			...
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'checkbox','id' => 'enableIssueDoi','label' => "plugins.pubIds.doi.manager.settings.enableIssueDoi",'maxlength' => '40','checked' => ((is_array($_tmp=$this->_tpl_vars['enableIssueDoi'])) ? $this->_run_mod_handler('compare', true, $_tmp, true) : $this->_plugins['modifier']['compare'][0][0]->smartyCompare($_tmp, true))), $this);?>
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'doiSuffixFormArea','title' => "plugins.pubIds.doi.manager.settings.doiSuffix")); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<?php $this->_tag_stack[] = array('fbvFormSection', array('list' => 'true')); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			...
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'text','id' => 'doiIssueSuffixPattern','value' => $this->_tpl_vars['doiIssueSuffixPattern'],'label' => "plugins.pubIds.doi.manager.settings.doiSuffixPattern.issues",'maxlength' => '40','inline' => true,'size' => $this->_tpl_vars['fbvStyles']['size']['MEDIUM']), $this);?>
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'doiReassignFormArea','title' => "plugins.pubIds.doi.manager.settings.doiReassign")); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<div class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.pubIds.doi.manager.settings.doiReassign.description"), $this);?>
</div>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
	<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
	<?php if (( $this->_tpl_vars['enableIssueDoi'] || $this->_tpl_vars['enableSubmissionDoi'] || $this->_tpl_vars['enableRepresentationDoi'] ) && $this->_tpl_vars['doiPrefix'] && $this->_tpl_vars['doiSuffix'] && $this->_tpl_vars['doiSuffix'] != 'customId'): ?>
		<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'doiAssignJournalWideFormArea','title' => "plugins.pubIds.doi.manager.settings.doiAssignJournalWide")); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				<div class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.pubIds.doi.manager.settings.doiAssignJournalWide.description"), $this);?>
</div>
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "linkAction/linkAction.tpl", 'smarty_include_vars' => array('action' => $this->_tpl_vars['assignJournalWidePubIdsLinkAction'],'contextId' => 'doiSettingsForm')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
