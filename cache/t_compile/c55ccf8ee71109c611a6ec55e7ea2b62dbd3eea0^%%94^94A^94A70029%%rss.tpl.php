<?php /* Smarty version 2.6.25-dev, created on 2019-03-02 21:17:31
         compiled from plugins/plugins/generic/webFeed/generic/webFeed:templates/rss.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/rss.tpl', 12, false),array('modifier', 'strip', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/rss.tpl', 23, false),array('modifier', 'replace', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/rss.tpl', 41, false),array('modifier', 'date_format', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/rss.tpl', 99, false),array('function', 'url', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/rss.tpl', 21, false),array('function', 'translate', 'plugins/plugins/generic/webFeed/generic/webFeed:templates/rss.tpl', 89, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
<rdf:RDF
	...
	<channel rdf:about="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journal']->getPath()), $this);?>
">
				<title><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['journal']->getLocalizedName())) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')); ?>
</title>
		<link><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journal']->getPath()), $this);?>
</link>
		...
		<prism:publicationName><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['journal']->getLocalizedName())) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'html')); ?>
...
?>
					<rdf:li rdf:resource="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['article']->getBestArticleId()), $this);?>
"/>
...
?>
    ...
    foreach ($_from as $this->_tpl_vars['article']):
?>
		<item rdf:about="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['article']->getBestArticleId()), $this);?>
">
			...
			<link><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'article','op' => 'view','path' => $this->_tpl_vars['article']->getBestArticleId()), $this);?>
</link>
...
" />
			...
			<?php endif; ?>
			<?php if ($this->_tpl_vars['issue']->getVolume() && $this->_tpl_vars['issue']->getShowVolume()): ?><prism:volume><?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getVolume())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</prism:volume><?php endif; ?>
			<?php if ($this->_tpl_vars['issue']->getNumber() && $this->_tpl_vars['issue']->getShowNumber()): ?><prism:number><?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getNumber())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
			...
			<?php if ($this->_tpl_vars['article']->getStoredPubId('doi')): ?>
				<prism:doi><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getStoredPubId('doi'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</prism:doi>
			<?php endif; ?>
		</item>
